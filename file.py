...
entity_label = Label(window, text='Add another account', font=('Courier', 18))
name_label = Label(window, text='Website URL: ', font=('Courier', 14))
...
submit = Button(window, text='Add Password', command=onsubmit, font=('Courier', 14))
